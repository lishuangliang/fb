import {localStorage} from '../ployfill/storage';

/**
 * 判断浏览器是否支持video autopaly
 * @param callback
 * @returns {*}
 */
export default function supportAutoPlay(callback) {
    //微信客户端直接需要点击才能播放
    ...
    //从localStorage获取
    if (localStorage.getItem('SUPPORT_VIDEO_AUTO_PLAY') != null) {
        return callback(localStorage.getItem('SUPPORT_VIDEO_AUTO_PLAY') == 'true');
    }
    ...
    function testAutoPlay(arg) {
        ...
        if (!result && currentTry < retries) {
            return timeout = setTimeout(testAutoPlay, waitTime);
        }

        elem.removeEventListener('playing', testAutoPlay, false);

        try {
            localStorage.setItem('SUPPORT_VIDEO_AUTO_PLAY', result); //存储结果
    ...
    elem.setAttribute('x-webkit-airplay', '');
